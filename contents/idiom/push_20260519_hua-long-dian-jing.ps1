# push_20260519_hua-long-dian-jing.ps1
# EP24 画龙点睛 — GitHub 자동 push 스크립트
...
$slug = "20260519_hua-long-dian-jing"
$episode = 24
$idiom = "画龙点睛"
...
git commit -m "ep${episode}: add $idiom (huà lóng diǎn jīng) script"
git push
