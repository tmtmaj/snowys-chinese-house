...
EPISODES = [
    ...
    },
    {
        ...
        "slug":    "fan-che",
        "pinyin":  "fān chē",
        "desc_en": "crash and burn",
        "search_query": "skincare bottle cosmetics",
        ...
        "script": {
            ...
            "p3_wrap":
                ...
                "好，我们来复习一下今天学的内容吧！",
            "closing":
                "好，今天我们学了翻车这个词，还学了很多实用的表达：\n"
                "当着大家的面、说的和做的、对不上、把话说满、\n"
        ...
        "paragraphs": [
            [
                {
                    "cn": "网上常说：∨他这次★翻车★了。",
                    "py": "Wǎngshàng cháng shuō: tā zhè cì fān chē le.",
                    "en": "Online you hear it all the time: he really crashed this time.",
                },
                {
                    "cn": "★翻车★，∨就是当着大家的面，∨说的和做的对不上了。",
                    "py": "Fān chē, jiù shì dāngzhe dàjiā de miàn, shuō de hé zuò de duì bu shàng le.",
                    "en": "翻车 is when, in front of everyone, what you said and what you did stop matching up.",
                },
                {
                    "cn": "越是把话说满，∨越容易★翻车★。",
                    "py": "Yuè shì bǎ huà shuō mǎn, yuè róngyì fān chē.",
                    "en": "The bigger the promise you make, the easier it is to crash.",
                },
            ],
            [
                {
                    "cn": "我关注的一个主播，∨那天在直播间卖护肤品。",
                    "py": "Wǒ guānzhù de yí ge zhǔbō, nà tiān zài zhíbōjiān mài hùfūpǐn.",
                    "en": "A streamer I follow was selling skincare in her livestream that day.",
                },
                {
                    "cn": "她说这瓶不到一百块，∨敏感肌用也绝对没问题。",
                    "py": "Tā shuō zhè píng bú dào yìbǎi kuài, mǐngǎnjī yòng yě juéduì méi wèntí.",
                    "en": "She said it's under a hundred kuai and absolutely safe even for sensitive skin.",
                },
                {
                    "cn": "夸得天花乱坠，∨三分钟就卖了十万瓶。",
                    "py": "Kuā de tiānhuā luànzhuì, sān fēnzhōng jiù mài le shí wàn píng.",
                    "en": "She hyped it to the skies — a hundred thousand bottles sold in three minutes.",
                },
            ],
            [
                {
                    "cn": "没过几天，∨评论区全是一句话：∨用完过敏了。",
                    "py": "Méi guò jǐ tiān, pínglùnqū quán shì yí jù huà: yòng wán guòmǐn le.",
                    "en": "A few days later the comments were all the same line: I broke out after using it.",
                },
                {
                    "cn": "退货的人越来越多，∨避雷的帖子也越来越多。",
                    "py": "Tuìhuò de rén yuè lái yuè duō, bìléi de tiězi yě yuè lái yuè duō.",
                    "en": "More and more people returned it, and more and more \"steer clear\" posts went up.",
                },
                {
                    "cn": "她后来删了那场回放，∨也再没说过绝对两个字。",
                    "py": "Tā hòulái shān le nà chǎng huífàng, yě zài méi shuō guo juéduì liǎng ge zì.",
                    "en": "She later deleted the replay — and never said the word \"absolutely\" again.",
                },
            ],
        ],
    },
